...
import '../style/InscriptionCollecteur.css';
import { FaEye, FaEyeSlash } from 'react-icons/fa';

const InscriptionCollecteur = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://localhost:8080/api/collecteurs/post', {
        nom,
        prenom,
        adresse,
        email,
...
export default InscriptionCollecteur;
